...
const DashboardIcon = ({ isSelected }) => {
  return (
    <svg
      width="27"
      height="27"
...
const InboxIcon = ({ isSelected, defaultColor }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
const Documents = ({ isSelected, defaultColor }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
