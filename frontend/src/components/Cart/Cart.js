      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="mb-8">
            ...
            {cartItems.length > 0 ? (
              cartItems.map((item) => (
                <div className="mb-4 flex flex-col items-start justify-between rounded bg-white p-4 shadow-md md:flex-row">
                  <img
        ...
        <div className="self-start rounded bg-white p-4 shadow-md md:p-8">
          <h2 className="mb-4 text-xl font-semibold">
            Total: ₹{cartItems[0].cart.total_price}
          </h2>
          <button className="w-full rounded bg-theme-primary py-2 text-lg font-semibold text-white hover:bg-purple-700">
            Checkout
          </button>
